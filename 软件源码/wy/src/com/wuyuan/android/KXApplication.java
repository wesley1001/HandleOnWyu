...
import com.wuyuan.android.result.ChatResult;
...
import com.wuyuan.android.result.FriendInfoResult;
import com.wuyuan.android.result.FriendsBirthdayResult;
import com.wuyuan.android.result.FriendsResult;
import com.wuyuan.android.result.GiftResult;
import com.wuyuan.android.result.HomeResult;
import com.wuyuan.android.result.LocationResult;
import com.wuyuan.android.result.LostResult;
import com.wuyuan.android.result.NearbyPeopleResult;
import com.wuyuan.android.result.NearbyPhotoResult;
import com.wuyuan.android.result.PhotoResult;
import com.wuyuan.android.result.PublicPageResult;
import com.wuyuan.android.result.RecommendResult;
import com.wuyuan.android.result.StatusResult;
import com.wuyuan.android.result.ViewedResult;
import com.wuyuan.android.result.VisitorsResult;
...
public class KXApplication extends Application {
	 ...
	 * 兼职招聘的数据
	 */
	public static List<ConcurrentJobResult> mConcurrentJobResults = new ArrayList<ConcurrentJobResult>();
	
	/**
	 * 捡到物品的数据
	 */
	public static List<LostResult> mPickResults = new ArrayList<LostResult>();
	
	/**
	 * 丢失物品的数据
	 */
	public static  List<LostResult> mLostResults = new ArrayList<LostResult>();

	/**
	 * 论坛数据
	 */
	public static  List<ForumResult> mForumResult = new ArrayList<ForumResult>();
