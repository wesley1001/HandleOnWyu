...
import com.wuyuan.android.menu.Desktop;
import com.wuyuan.android.menu.Forum;
import com.wuyuan.android.menu.Home;
import com.wuyuan.android.menu.Lbs;
import com.wuyuan.android.menu.Lost;
import com.wuyuan.android.menu.Recommend;
import com.wuyuan.android.menu.User;
import com.wuyuan.android.menu.Viewed;
import com.wuyuan.android.menu.currentJob;
import com.wuyuan.android.menu.library;
import com.wuyuan.android.menu.Desktop.onChangeViewListener;
import com.wuyuan.android.ui.base.FlipperLayout;
...
public class MainActivity extends KXActivity implements OnOpenListener {
	 ...
	 * 消息首页界面
	 */
	private Lost mMessage;
	/**
	 * 好友首页界面
	 */
	private currentJob mFriends;
	/**
	 * 照片首页界面
	 */
	private library mPhoto;
	/**
	 * 转帖首页界面
	 */
		...
		mDesktop.setOnChangeViewListener(new onChangeViewListener() {
			...
			public void onChangeView(int arg0) {
				...
				case ViewUtil.MESSAGE:
					if (mMessage == null) {
						mMessage = new Lost(MainActivity.this,mKXApplication);
				...
				case ViewUtil.FRIENDS:
					if (mFriends == null) {
						mFriends = new currentJob(MainActivity.this,
								mKXApplication);
				...
				case ViewUtil.PHOTO:
					if (mPhoto == null) {
						mPhoto = new library(MainActivity.this, mKXApplication,
								mScreenWidth);
				...
				case ViewUtil.GIFTS:
					if (mGifts == null) {
						mGifts = new Forum(MainActivity.this, mKXApplication);
